package com.gonext.live.gps.navigation.utils.view;
...
public class CustomEditText extends AppCompatEditText {
    ...
    private void initCustomEditText(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            switch (textFont) {
                case 1:
                    textFontType = "sanfranciscodisplay_regular.otf";
                    break;
                case 2:
                    textFontType = "sanfranciscodisplay_regular.otf";
                    break;
                case 3:
                    textFontType = "sanFranciscodisplay_heavy.otf";
                    break;
                case 4:
                    textFontType = "sanfranciscodisplay_light.otf";
                    break;
                case 5:
                    textFontType = "sanfranciscodisplay_medium.otf";
                    break;
                default:
                    textFontType = "sanfranciscodisplay_light.otf";
                    break;
